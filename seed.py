...
# create_animal(name="Pippi",type="dog",breed="retriever",age=11, gender="female",adopt_code=12524,entry_source="admin",url="animalurl.com",shelter=shelter, bio="test bio",weight=12,scheduled_euthanasia_date="04/12/2025",join_date="01/10/2024")
...
# create_animal(name="Donald",type="dog",breed="pitbull",age=5, gender="male",adopt_code=1454,entry_source="admin",url="animal32url.com",shelter=shelter, bio="test bio",weight=10,scheduled_euthanasia_date="04/02/2025",join_date="01/10/2024")
# create_animal(name="Ronald",type="dog",breed="lab",age=5, gender="male",adopt_code=19454,entry_source="admin",url="animal3url.com",shelter=shelter, bio="test bio",weight=10,scheduled_euthanasia_date="04/02/2025",join_date="01/10/2024")
# create_animal(name="Linguine",type="cat",breed="mix",age=12, gender="female",adopt_code="A123",entry_source="admin",url="animal34url.com",shelter=shelter, bio="test bio",weight=4,scheduled_euthanasia_date="05/02/2025",join_date="01/10/2024")

...
class FormTest(unittest.TestCase):
    ...
    def test_Name_animal(self):
        ...
        data = MultiDict(
            {"type": "Test Type", "breed": "Test breed", "auth": os.environ["password"]}
        )
        form = forms.AnimalForm(data)
        self.assertFalse(form.validate())
    ...
    def test_type_animal(self):
        ...
        data = MultiDict(
            {"name": "Test Name", "breed": "Test breed", "auth": os.environ["password"]}
        )
        form = forms.AnimalForm(data)
        self.assertFalse(form.validate())
    ...
    def test_breed_animal(self):
        ...
        data = MultiDict(
            {"name": "Test Name", "type": "Test Type", "auth": os.environ["password"]}
        )
        form = forms.AnimalForm(data)
        self.assertFalse(form.validate())
